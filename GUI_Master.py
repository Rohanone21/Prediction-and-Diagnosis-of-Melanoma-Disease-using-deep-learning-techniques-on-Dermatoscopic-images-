...
#
label_l1 = tk.Label(root, text="Melanoma Skin Cancer Detection",font=("Times New Roman", 35, 'bold'),
                    background="#152238", fg="white", width=60, height=1)
label_l1.place(x=0, y=0)



lbl = tk.Label(root, text="Melanoma Skin Cancer Detection", font=('times', 35,' bold '), height=1, width=65,bg="#3598a5",fg="white")
lbl.place(x=0, y=0)
...
def train_model():
    ...
    # Create the model using the U-Net architecture
    X = CNNModel.main()

    # Get the model summary as a string
    model_summary = io.StringIO()
    X.summary(print_fn=lambda x: model_summary.write(x + '\n'))
